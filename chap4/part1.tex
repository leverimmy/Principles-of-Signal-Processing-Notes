...
\begin{solution}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \node at (axis cs:3.14, 0) [anchor=north] {$\pi$};
            \node at (axis cs:6.28, 0) [anchor=north] {$2\pi$};
            \end{axis}
        \end{tikzpicture}
        \caption{习题 \theexercise~ 幅频响应函数}
