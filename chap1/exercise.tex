            ...
            \begin{enumerate}
                ...
                \item 当 $-1 < t \le 0$ 时，有
                    \begin{align*}
                        ...
                        & = 0 + \left(\frac{1}{2}a^2 + (1 - t)a\right)\bigg\vert_{a = -1}^{a = t} - t + \left(-\frac{1}{2}a^2 + a\right)\bigg\vert_{a = 0}^{a = t + 1} \\
                ...
                \item 当 $0 < t \le 1$ 时，有
                    \begin{align*}
                        ...
                        & = \left(\frac{1}{2}a^2 + (1 - t)a\right)\bigg\vert_{a = t - 1}^{a = 0} + \left(-\frac{1}{3}a^3 + \frac{1}{2}ta^2 - (t - 1)a\right)\bigg\vert_{a = 0}^{a = t} + \left(-\frac{1}{2}a^2 + a\right)\bigg\vert_{a = t}^{a = 1} \\
                ...
                \item 当 $1 < t \le 2$ 时，有
                    \begin{align*}
                        ...
                        & = \left(-\frac{1}{3}a^3 + \frac{1}{2}ta^2 - (t - 1)a\right)\bigg\vert_{a = t - 1}^{a = 1} \\
            ...
            \begin{enumerate}
                ...
                \item 当 $-\frac{3}{2} < t \le -1$ 时，有
                    \begin{align*}
                        ...
                        & = 0 + 0 + \left(-\frac{1}{2}a^2 + (t + 1)a\right)\bigg\vert_{a = -1/2}^{a = t + 1} \\
                ...
                \item 当 $-1 < t \le -\frac{1}{2}$ 时，有
                    \begin{align*}
                        ...
                        & = 0 + 0 + \left(-\frac{1}{2}a^2 + (t + 1)a\right)\bigg\vert_{a = -1/2}^{a = 0} + \left(\frac{2}{3}a^3 - \frac{2t + 3}{2}a^2 + (t + 1)a\right)\bigg\vert_{a = 0}^{a = t + 1} \\
                ...
                \item 当 $-\frac{1}{2} < t \le 0$ 时，
                    \begin{align*}
                        ...
                        & = 0 + t + \frac{1}{2} + \left(-\frac{1}{2}a^2 + (t + 1)a\right)\bigg\vert_{a = t}^{a = 0} + \left(\frac{2}{3}a^3 - \frac{2t + 3}{2}a^2 + (t + 1)a\right)\bigg\vert_{a = 0}^{a = 1/2} + 0 \\
                ...
                \item 当 $0 < t \le \frac{1}{2}$ 时，有
                    \begin{align*}
                        ...
                        & = 0 + \frac{1}{2} + \left(a - a^2\right)\bigg\vert_{a = 0}^{a = t} + \left(\frac{2}{3}a^3 - \frac{2t + 3}{2}a^2 + (t + 1)a\right)\bigg\vert_{a = t}^{a = 1/2} + 0 \\
                ...
                \item 当 $\frac{1}{2} < t \le 1$ 时，有
                    \begin{align*}
                        ...
                        & = 1 - t + \left(-a^2 + a\right)\bigg\vert_{a = 0}^{a = 1/2} + 0 + 0 \\
                        & = 1 - t + \frac{1}{4} \\
                        & = -t + \frac{5}{4}.
                    \end{align*}
                \item 当 $1 < t \le \frac{3}{2}$ 时，有
                    \begin{align*}
                        ...
                        & = \left(-a^2 + a\right)\bigg\vert_{a = t - 1}^{a = 1/2} + 0 + 0 \\
                        & = \frac{1}{4} - (-(t - 1)^2 + (t - 1)) \\
                        & = t^2 - 3t + \frac{9}{4}.
                    \end{align*}
